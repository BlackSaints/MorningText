...
public class MDesignActivity extends AppCompatActivity {

    Class[] acy = {TextViewActivity.class,MRecycleViewActivity.class,MToolbarActivity.class,MAppbarLayoutActivity.class};
    String[] btnName = {"TextView","RecycleView","Toolbar","AppbarLayout"};
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                startActivity(new Intent(MDesignActivity.this, acy[position]));
            }
        });
    }
}
